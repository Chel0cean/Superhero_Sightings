 ...
 INSERT INTO Superpower(idSuperpower, name) VALUES 
    ...
    (4, "NEEDTOCHANGE_Uncontrollable Vomiting"),
    (5, "Telekinesis"),
    (6, "Teleportation"),
    ...
    ("NEEDTOCHANGE-Janitor Poopatine","Can cause extreme fear, and breathe Fire alias Russell Russ",4),
    ...
    ("The Southwest Center for Bad-doing", 1, "A large obsidian glass building that reflects the southwest sun into the eyes of all that pass by. Its mere existence has been the cause of many car accidents.", "contact@me", "5555555"),
    ("The Thermopolis House of Integrity", 2, "Hidden underground, rumored to have a secret rocket launch pad.", "contact@me", "5555555"),
    ("Virtual Reality Simulation", 3, "A portal gun allows you to visit the Virtual Reality Simulation. Located in a secret location called 404", "contact@me", "5555555"),
    ("Fire Nation", 4, "Located in an island called Fire Island.", "contact@me", "5555555"),
    ("The Post", 5, " A lotus looking building that is made of steel. Finger prints needed to enter.", "contact@me", "5555555"),
    ("The Way", 6, "Far away in the middle of BadLands, SandHouse blends right into the Environment.", "contact@me", "5555555"),
    ("Fantastic Four", 7, "A family dedicated to saving the planet.", "contact@me", "5555555"),
    ("Doomers", 8, "Earth’s worst supervillain team located under Penn Station.", "contact@me", "5555555");
